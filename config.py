...
OWNER_ID = int(getenv("OWNER_ID", "5699973443"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/crazzysuport")
SUPPORT_CHAT = getenv("SUPPORT_GROUP", "https://t.me/crazzy07_network")
